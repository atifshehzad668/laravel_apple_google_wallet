    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div style="text-align: center; margin: 30px 0;">
                <h3 style="margin-bottom: 15px;">Your Digital Membership Pass</h3>
            ...
            <p style="margin-top: 30px;">
                Your digital membership pass is now ready. Scan the QR code above or follow the link to view your premium digital card, which can be used for verification at our locations.
            </p>
